...
Public Class DataSetTranOrderForms
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DataSetTranOrderForms = CType(MyBase.Clone,DataSetTranOrderForms)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DataSetTranOrderForms"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DataSetTranOrderForms.xsd"
